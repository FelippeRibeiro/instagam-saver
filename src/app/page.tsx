    ...
    <>
      <div className="w-screen h-screen flex flex-col items-center ">
        ...
        <div className="w-[50%] flex flex-col items-center max-lg:w-[90%]">
          ...
          />
          <button className="border bg-blue-400 px-5 py-2 rounded-md hover:bg-blue-500 m-2" onClick={() => handleDownload()}>
            Download
          </button>
        </div>
              ...
              return (
                ...
                >
                  <Link href={item.link} target="_blank" className="flex flex-col items-center ">
                    <Image src={item.thumb} width={200} height={300} alt="item" placeholder="blur" blurDataURL="/logo.png"></Image>
